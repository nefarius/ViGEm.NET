...
public abstract class Xbox360Property : IComparable
{
    ...
    {
        Xbox360Property otherValue = obj as Xbox360Property;
...
{
    public static readonly Xbox360Button Up = new UpButton();
    public static readonly Xbox360Button Down = new DownButton();
    public static readonly Xbox360Button Left = new LeftButton();
    public static readonly Xbox360Button Right = new RightButton();
    public static readonly Xbox360Button Start = new StartButton();
    public static readonly Xbox360Button Back = new BackButton();
    public static readonly Xbox360Button LeftThumb = new LeftThumbButton();
    public static readonly Xbox360Button RightThumb = new RightThumbButton();
    public static readonly Xbox360Button LeftShoulder = new LeftShoulderButton();
    public static readonly Xbox360Button RightShoulder = new RightShoulderButton();
    public static readonly Xbox360Button Guide = new GuideButton();
    public static readonly Xbox360Button A = new AButton();
    public static readonly Xbox360Button B = new BButton();
    public static readonly Xbox360Button X = new XButton();
    public static readonly Xbox360Button Y = new YButton();

    private Xbox360Button(int id, string name, ushort value)
        : base(id, name)
    {
        Value = value;
    }
...
{
    public static readonly Xbox360Axis LeftThumbX = new LeftThumbXAxis();
    public static readonly Xbox360Axis LeftThumbY = new LeftThumbYAxis();
    public static readonly Xbox360Axis RightThumbX = new RightThumbXAxis();
    public static readonly Xbox360Axis RightThumbY = new RightThumbYAxis();

    private Xbox360Axis(int id, string name)
        : base(id, name)
    {
    }
...
{
    public static readonly Xbox360Slider LeftTrigger = new LeftTriggerSlider();
    public static readonly Xbox360Slider RightTrigger = new RightTriggerSlider();

    private Xbox360Slider(int id, string name)
        : base(id, name)
    {
    }
